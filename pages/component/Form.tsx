...
const useStyles = makeStyles({
    root: {
        ...
        marginBottom: 16,
        padding: 16,
        boxShadow: "0px 3px 5px -1px rgba(0,0,0,0.9), 0px 6px 10px 0px rgba(0,0,0,0.5), 0px 1px 18px 0px rgba(0,0,0,0.6)"
    },
    button: {
        marginTop: 16
    },
...
const Form = ({ title, setTitle, addItem, editItem, edit, error, setError } : Record<string, any>) => {
